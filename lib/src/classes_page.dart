...
class _ClassPage extends State<ClassPage> {
  ...
  late int classmanagecode =
      0; //used to select which class is picked when you press manage

  late int timesendcode =
      0; //used to know what class is being selected for time when you press save
  ...
  late int addclasssendcode =
      0; //used to know what class the add class button was pressed for so it can make it visable

  late String buldingselect =
      ""; //used for cords to know what building was selected
                      ...
                      children: [
                        Container(
                          ...
                          child: Column(
                            children: [
                              FadeInImage(
                                image: NetworkImage(class1image),
                      ...
                      children: [
                        Container(
                          ...
                          child: Column(
                            children: [
                              FadeInImage(
                                image: NetworkImage(class2image),
                      ...
                      children: [
                        Container(
                          ...
                          child: Column(
                            children: [
                              FadeInImage(
                                image: NetworkImage(class3image),
                                placeholder: const AssetImage(
                                    'assets/images/image_avc_logo.png'),
                                imageErrorBuilder: (c, o, s) => Image.asset(
                                  'assets/images/image_avc_logo.png',
                      ...
                      children: [
                        Container(
                          ...
                          child: Column(
                            children: [
                              FadeInImage(
                                image: NetworkImage(class4image),
                                placeholder: const AssetImage(
                                    'assets/images/image_avc_logo.png'),
                                imageErrorBuilder: (c, o, s) => Image.asset(
                                  'assets/images/image_avc_logo.png',
                      ...
                      children: [
                        Container(
                          ...
                          child: Column(
                            children: [
                              FadeInImage(
                                image: NetworkImage(class5image),
                                placeholder: const AssetImage(
                                    'assets/images/image_avc_logo.png'),
                                imageErrorBuilder: (c, o, s) => Image.asset(
                                  'assets/images/image_avc_logo.png',
                      ...
                      children: [
                        Container(
                          ...
                          child: Column(
                            children: [
                              FadeInImage(
                                image: NetworkImage(class6image),
                                placeholder: const AssetImage(
                                    'assets/images/image_avc_logo.png'),
                                imageErrorBuilder: (c, o, s) => Image.asset(
                                  'assets/images/image_avc_logo.png',
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                    class6name, // This should likely be class6name, assuming a similar pattern
                                    style: const TextStyle(
                                      fontSize: 18.5,
                                      fontWeight: FontWeight.bold,
                                    ),
                      ...
                      children: [
                        Container(
                          ...
                          child: Column(
                            children: [
                              FadeInImage(
                                image: NetworkImage(class7image),
                                placeholder: const AssetImage(
                                    'assets/images/image_avc_logo.png'),
                                imageErrorBuilder: (c, o, s) => Image.asset(
                                  'assets/images/image_avc_logo.png',
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                    class7name, // Update to class7name accordingly
                                    style: const TextStyle(
                                      fontSize: 18.5,
                                      fontWeight: FontWeight.bold,
                                    ),
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            ...
                            int? previousMinute =
                                prefs.getInt('selectedMinute');
                            TimeOfDay initialTime = previousHour != null &&
                                    previousMinute != null
                                ? TimeOfDay(
                  ...
                  SelectWeekDays(
                    ...
                    onSelect: (values) {
                      ...
                      if (classmanagecode == 1) {
                        ...
                        class1day =
                            class1day.substring(1, class1day.length - 1);
                      } else if (classmanagecode == 2) {
                        class2day = values.toString();
                        class2day =
                            class2day.substring(1, class2day.length - 1);
                      } else if (classmanagecode == 3) {
                        class3day = values.toString();
                        class3day =
                            class3day.substring(1, class3day.length - 1);
                      } else if (classmanagecode == 4) {
                        class4day = values.toString();
                        class4day =
                            class4day.substring(1, class4day.length - 1);
                      } else if (classmanagecode == 5) {
                        class5day = values.toString();
                        class5day =
                            class5day.substring(1, class5day.length - 1);
                      } else if (classmanagecode == 6) {
                        class6day = values.toString();
                        class6day =
                            class6day.substring(1, class6day.length - 1);
                      } else if (classmanagecode == 7) {
                        class7day = values.toString();
                        class7day =
                            class7day.substring(1, class7day.length - 1);
                      }
                    },
                  ),
                  const Divider(
